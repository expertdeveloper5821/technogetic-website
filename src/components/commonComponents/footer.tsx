      ...
      <div className={styles["container"]}>
        ...
        <div className={styles["footer"]}>
          ...
          <div className={styles["footer-service"]}>
            <h3>Let's Connect</h3>
            <ul>
              <li>info@technogetic.com</li>
              <li>hr@technogetic.com</li>
            </ul>
            <div className={styles["glassdoor"]}>
              {/* <Link href="https://www.glassdoor.co.in/Overview/Working-at-Technogetic-EI_IE7424608.11,22.htm">
                <Image
